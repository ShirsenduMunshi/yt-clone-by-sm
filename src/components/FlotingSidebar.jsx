...
function FlotingSidebar() {
    ...
    return (
        <div className="px-6 w-[17%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden absolute bg-slate-50 duration-1000">
            {/* Home */}
            ...
            <br />
            <p className="text-xs text-gray-500 mt-3">© 2024 Shirsendu Munshi</p>
        </div>
    );
}
